              ...
              <div>
                    ...
                    <div className="mb-5 mr-10 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image
                            src="public/images/blog/author-01.png"
                            alt="author"
                            fill
                          />
                        </div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    It’s like a transparent window into your code, empowering you with unprecedented control, security, and agility.<br>Imagine a world where:</br>
                  </p>
                  ...
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Ready to join the SBOM revolution? Stay tuned for our next blog post, where we will dive deeper into the practical implementation of SBOMs for developers and small businesses. 
                    We will provide tips, tricks, and resources to help you harness the power of SBOMs and build a future-proof software landscape.
                  </p>
